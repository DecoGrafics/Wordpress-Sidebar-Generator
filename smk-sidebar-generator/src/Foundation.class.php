...
abstract class Foundation {
	...
	public function enqueue(){
		if( $this->isPluginPage() ){
			...
			/* Tipped
			--------------*/
			wp_register_style( 'smk-sidebar-generator-tipped', $this->uri() . 'assets/tipped/tipped.css', '', $this->version );
			wp_enqueue_style( 'smk-sidebar-generator-tipped' );
			
			wp_register_script( 'smk-sidebar-generator-tipped', $this->uri() . 'assets/tipped/tipped.js', $depend, $this->version, true );
			wp_enqueue_script( 'smk-sidebar-generator-tipped' );
			
			/* Select2
			---------------*/
			wp_register_style( 'smk-sidebar-generator-select2', $this->uri() . 'assets/select2/css/select2.min.css', '', $this->version );
			wp_enqueue_style( 'smk-sidebar-generator-select2' );
			
			wp_register_script( 'smk-sidebar-generator-select2', $this->uri() . 'assets/select2/js/select2.min.js', $depend, $this->version, true );
			wp_enqueue_script( 'smk-sidebar-generator-select2' );

<?php
class SMK_SIDEBAR_Plugin_Autoloader{
	...
	*/
	public function autoloadEngine( $class ){
		$prefix   = ssgm_config( 'namespace' ) .'\\';
		$base_dir = SMK_SIDEBAR_PATH .'engine/';
	...
	*/
	public function autoloadComponents( $class ){
		$prefix   = ssgm_config( 'namespace' ) .'\\Component\\';
		$base_dir = SMK_SIDEBAR_PATH .'components/';
...
new SMK_SIDEBAR_Plugin_Autoloader;